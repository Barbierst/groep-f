...
public class SettingsButton extends Button{
    public SettingsButton(Coordinate2D initialLocation, World world) {
        super(initialLocation, "Settings", world, Color.GREEN, Color.GREENYELLOW);
    }
